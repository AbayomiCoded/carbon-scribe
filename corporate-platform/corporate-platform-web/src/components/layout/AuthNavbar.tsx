  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 md:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3" aria-label="CarbonScribe home">
        ...
        <nav className="flex items-center gap-2 sm:gap-3" role="navigation" aria-label="Authentication navigation">
          <Link
            href="/login"
